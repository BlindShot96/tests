...
namespace SimpleTestCreator.UserControls {
    public class WpfNumericUpDown : Control
    {
        static WpfNumericUpDown()
        {
            InitializeCommands();

            // Listen to MouseLeftButtonDown event to determine if slide should move focus to itself
            EventManager.RegisterClassHandler(typeof(WpfNumericUpDown), 
                Mouse.MouseDownEvent, new MouseButtonEventHandler(WpfNumericUpDown.OnMouseLeftButtonDown), true);
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register(
                "Value", typeof(decimal), typeof(WpfNumericUpDown),
        ...
        {
            WpfNumericUpDown nudCtrl = (WpfNumericUpDown)obj;
        ...
        private static object CoerceValue(DependencyObject element, object value)
        {
            ...
            WpfNumericUpDown control = (WpfNumericUpDown)element;
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register(
                "Minimum", typeof(decimal), typeof(WpfNumericUpDown),
        ...
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register(
                "Maximum", typeof(decimal), typeof(WpfNumericUpDown),
        ...
        public static readonly DependencyProperty ChangeProperty =
            DependencyProperty.Register(
                "Change", typeof(decimal), typeof(WpfNumericUpDown),
        ...
        public static readonly DependencyProperty DecimalPlacesProperty =
            DependencyProperty.Register(
                "DecimalPlaces", typeof(int), typeof(WpfNumericUpDown),
        ...
        private static readonly DependencyPropertyKey ValueStringPropertyKey =
            DependencyProperty.RegisterAttachedReadOnly("ValueString", typeof(string), typeof(WpfNumericUpDown), new PropertyMetadata());
        ...
        public static readonly RoutedEvent ValueChangedEvent = EventManager.RegisterRoutedEvent(
            ...
            typeof(RoutedPropertyChangedEventHandler<decimal>), typeof(WpfNumericUpDown));
        ...
        {
            _increaseCommand = new RoutedCommand("IncreaseCommand",typeof(WpfNumericUpDown));
            CommandManager.RegisterClassCommandBinding(typeof(WpfNumericUpDown), new CommandBinding(_increaseCommand, OnIncreaseCommand));
            CommandManager.RegisterClassInputBinding(typeof(WpfNumericUpDown), new InputBinding(_increaseCommand, new KeyGesture(Key.Up)));

            _decreaseCommand = new RoutedCommand("DecreaseCommand", typeof(WpfNumericUpDown));
            CommandManager.RegisterClassCommandBinding(typeof(WpfNumericUpDown), new CommandBinding(_decreaseCommand, OnDecreaseCommand));
            CommandManager.RegisterClassInputBinding(typeof(WpfNumericUpDown), new InputBinding(_decreaseCommand, new KeyGesture(Key.Down)));
        }

        private static void OnIncreaseCommand(object sender, ExecutedRoutedEventArgs e)
        {
            WpfNumericUpDown control = sender as WpfNumericUpDown;
            if (control != null)
            {
                control.OnIncrease();
            }
        ...
        {
            WpfNumericUpDown control = (WpfNumericUpDown)sender;
    ...
    {
        public NumericUpDownAutomationPeer(WpfNumericUpDown control)
            : base(control)
        {
        }
        ...
        private WpfNumericUpDown MyOwner
        {
            get
            {
                return (WpfNumericUpDown)base.Owner;
            }
        }
    }
}
